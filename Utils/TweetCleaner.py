...
class TweetCleaner:
    ...
    # tokens_pattern = r'((@?|\#?)[_پچجحخهعغفقثصضشسیبلاتنمکگودذرزطظژآ]+)'
    tokens_pattern = r'(((\#)[_پچجحخهعغفقثصضشسیبلاتنمکگودذرزطظژ]+)|[پچجحخهعغفقثصضشسیبلاتنمکگودذرزطظژ]+)'
    ...
    def clean(self, t):
        return self.__tokens(self.__remove_urls(t))
